...
import { useWishlist } from "./WishlistContext"; // Added the import
    ...
    <div className="min-h-screen bg-white text-black p-6 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[240px] w-full max-w-5xl">
        {wishlist.map((item, i) => (
          <div
            key={item.id}
            className={`border border-black/20 rounded-2xl overflow-hidden shadow-sm bg-white flex flex-col ${
            ...
            <div className="p-4 flex flex-col gap-2 bg-white">
              ...
              <div className="flex justify-between mt-2">
                <button
                  ...
                  className="px-3 py-2 border border-black rounded-lg hover:bg-black hover:text-white transition text-xs flex items-center gap-1"
                >
